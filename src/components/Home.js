    ...
    <div className="overallDiv">
      <div className="container">
        <div className="left-section">
          <p className="gradient-text">Hello, I'm Ashok</p>
      ...
      <a
  href={process.env.PUBLIC_URL + '/ashoknew.pdf'} target="_blank" rel="noopener noreferrer"
  style={{
    padding: '10px 20px',
...
<SiReact style={{ color: '#61DAFB', marginRight: 8, width: 30, height: 30  }} />
  ...
  <div className="contact-info">
    <p className="contact-item">
      📞  <a href="tel:+91 6300719788">Phone : +91 6300719788</a>
    </p>
    <p className="contact-item">
      📧  <a href="mailto:gudipudiashok09@gmail.com">gudipudiashok09@gmail.com</a>
    </p>
  </div>
