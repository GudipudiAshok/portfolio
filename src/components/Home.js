...
const Home = () => {
  ...
  useEffect(() => {
    AOS.init({
      once: false,         // 👈 This enables animation every time
...
<p className="gradient-text text-3xl md:text-5xl font-bold transition-opacity duration-500">
<span>👋</span> Hello, I'm Gudipudi Ashok<span className="text-purple-500"></span>
    </p>
...
<div className="flex flex-col md:flex-row gap-4 items-center justify-start ">
  <a
    href={process.env.PUBLIC_URL + '/ashoknew.pdf'}
    target="_blank"
...
<div className="expertise-section grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            ...
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a
                     href="https://github.com/GudipudiAshok/googlemaplive"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  <button className="btn2">GitHub</button>
...
>
  ...
  >
    ...
    >
      ...
      <a
        href="mailto:gudipudiashok315@gmail.com"
        style={{
          fontSize: '16px',
          color: '#5b21b6',
          textDecoration: 'none',
...
<div style={{ maxWidth: '100%', marginTop: '40px' }}>
  ...
  <div style={{
    ...
    © {new Date().getFullYear()} Ashok. All rights reserved.
  </div>
</div>
