...
import TicTacToeImage from '../assets/ticto.jpeg';
            ...
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a
                    href="https://github.com/GudipudiAshok/QrBarcodeScanner"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  <button className="btn2">GitHub</button>
            ...
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  ...
                  <a
                    href="https://github.com/GudipudiAshok/StreatView"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  <button className="btn2">GitHub</button>
            ...
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  ...
                  <a
                    href="https://github.com/GudipudiAshok/CustomizeCamerWithCrop"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  <button className="btn2">GitHub</button>
                  ...
                  {/* https://github.com/GudipudiAshok/CustomizeCamerWithCrop */}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mobileproject-card border-purple">
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                <a
                    href="https://gudipudiashok.github.io/tictactoe/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <button className="btn1">Live</button>
                  ...
                  <a
                    href="https://github.com/GudipudiAshok/tictactoe"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  <button className="btn2">GitHub</button>
...
Ideal for elderly users or anyone managing multiple prescriptions.
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a
                    href="https://github.com/GudipudiAshok/MedicineNotificationReminder"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  <button className="btn2">GitHub</button>
