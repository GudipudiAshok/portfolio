...
function Projects() {
          ...
          <div className="project-card1 border-blue slide-in-left">
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a href="https://github.com/GudipudiAshok/QrBarcodeScanner/tree/main/QrBarcodeScanner-main" target="_blank" rel="noopener noreferrer">
                    <button className="btn2">GitHub</button>
                  </a>
                </div>
              </div>
          ...
          <div className="project-card1 border-purple slide-in-right">
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a href="https://github.com/GudipudiAshok/StreatView" target="_blank" rel="noopener noreferrer">
                    <button className="btn2">GitHub</button>
                  </a>
                </div>
              </div>
          ...
          <div className="project-card1 border-green slide-in-left">
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a href="https://github.com/GudipudiAshok/googlemaplive" target="_blank" rel="noopener noreferrer">
                    <button className="btn2">GitHub</button>
                  </a>
                </div>
              </div>
          ...
          <div className="project-card1 border-blue slide-in-right">
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a href="https://github.com/GudipudiAshok/CustomizeCamerWithCrop" target="_blank" rel="noopener noreferrer">
                    <button className="btn2">GitHub</button>
                  </a>
                </div>
              </div>
          ...
          <div className="project-card1 border-purple slide-in-left">
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a href="https://github.com/GudipudiAshok/tictactoe" target="_blank" rel="noopener noreferrer">
                    <button className="btn2">GitHub</button>
                  </a>
                </div>
              </div>
          ...
          <div className="project-card1 border-purple slide-in-left">
            <div className="cardContent">
              ...
              <div className="cardText">
                ...
                <div className="buttons">
                  <button className="btn1">Live</button>
                  <a href="https://github.com/GudipudiAshok/MedicineNotificationReminder" target="_blank" rel="noopener noreferrer">
                    <button className="btn2">GitHub</button>
                  </a>
                </div>
              </div>
  ...
  <a
    href="https://github.com/GudipudiAshok/chess"
    target="_blank"
  ...
  <h3 className='projectName'>Chat & Voice Assistnace AI </h3>
    ...
    <div className="liveBt">
      ...
      <a
          href="https://github.com/GudipudiAshok/ChatBotGoogleAssistanceAI"
                    target="_blank"
                    rel="noopener noreferrer"
                     className="webbtn2"
                  >
